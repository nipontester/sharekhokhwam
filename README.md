...
เปิด `http://localhost:3000` (หรือ 8000) **สองแท็บ** ตั้งชื่อห้องเดียวกันทั้งคู่ แล้วพิมพ์ในแท็บหนึ่ง อีกแท็บจะขยับตามทันที 🎉
...
- **ระบบห้อง (ต้องตั้งชื่อห้องก่อน)** — เปิดเว็บมาช่องพิมพ์จะล็อกอยู่ ต้องพิมพ์ชื่อห้องที่ป้ายด้านบนแล้วกด Enter ก่อน (หรือเปิดลิงก์ที่มี `#ชื่อห้อง` ต่อท้าย เช่น `https://your-site.netlify.app/#ทีมเรา`) แต่ละห้องมีข้อความแยกกัน ปุ่ม "คัดลอกลิงก์ห้องนี้" ไว้ส่งให้เพื่อน
